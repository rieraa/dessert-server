...
import com.example.desserts.config.OSSConfig;
...
public class FileServiceImpl implements FileService {
    ...
    public String upload(MultipartFile file) {
        ...
        //在OSS上bucket下的文件名
        String uploadFileName = "dessert/" + folder + "/" + fileName + extension;
        ...
        try {
            ...
            throw new BusinessException(BusinessCode.FILE_UPLOAD_ERROR);
        } finally {
            //OSS关闭服务，不然会造成OOM
            ossClient.shutdown();
        }
